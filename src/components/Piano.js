...
export class Piano extends HTMLElement {
    ...
    onMouseDown(event) {
        ...
        } else if ((this.type === 'whitenoise') || (this.type === 'pinknoise') || (this.type === 'browniannoise')) {
    ...
    setAttributes() {
        ...
        if ((this.type !== 'piano') || (this.type !== 'whitenoise') || (this.type !== 'pinknoise') || (this.type !== 'browniannoise')) {
